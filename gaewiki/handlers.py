...
class ImageServeHandler(RequestHandler):
    def get(self):
        ...
        data = {
            "meta": img.get_info(),
            "versions": [
                ("postzegel", img.get_url(75, True), img.get_code(75, True)),
                ("klein", img.get_url(200, False), img.get_code(200, False)),
                ("middelgroot", img.get_url(500, False), img.get_code(500, False)),
            ]
        }
