...
def get_sidebar():
    ...
    if page.is_saved():
        ...
        body = u'<a href="/"><img src="/gae-wiki-static/logo-186.png" width="186" alt="logo" height="167"/></a>\n\nPlaats hier een korte omschrijving van de wiki, een logo en andere vermeldingen.\n\n[Verander deze tekst](/w/edit?page=%s)' % page_name
    return body
...
def get_footer():
    ...
    if page.is_saved():
        ...
        body = u'Deze [Wiki](https://github.com/BauweBijl/gaewiki-nl), is in het Nederlands vertaald en geoptimaliseerd voor Google Appengine met Python 2.7 door [Bauwe Bijl](http://www.bauwe.nl/).'
    return body
